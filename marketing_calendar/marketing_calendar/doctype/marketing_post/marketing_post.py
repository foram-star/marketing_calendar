...
class MarketingPost(Document):
	# begin: auto-generated types
	from typing import TYPE_CHECKING

	if TYPE_CHECKING:
		from frappe.types import DF
		from marketing_calendar.marketing_calendar.doctype.marketing_post_asset.marketing_post_asset import (
			MarketingPostAsset,
		)
		from marketing_calendar.marketing_calendar.doctype.marketing_post_platform.marketing_post_platform import (
			MarketingPostPlatform,
		)
		from marketing_calendar.marketing_calendar.doctype.marketing_post_tag.marketing_post_tag import (
			MarketingPostTag,
		)

    ...
    <template #body>
      <div class="flex max-h-[88vh] flex-col">
        <div class="flex items-center gap-3 border-b border-gray-100 px-5 py-4">
          ...
          <span class="text-[11.5px] text-ink-gray-6">Mock layout — nothing is fetched from the real platform</span>
        </div>
        ...
        <div class="flex-1 overflow-auto bg-gray-50 px-5 py-5">
          <p v-if="!active" class="m-0 text-center text-[12.5px] text-ink-gray-6">Pick a platform first.</p>
